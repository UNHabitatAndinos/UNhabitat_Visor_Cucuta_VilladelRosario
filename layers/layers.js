...
lyr_reaurbanaCcutayVilladelRosario_10.set('fieldImages', {'ID_MANZA_1': 'TextEdit', 'ID_MANZANA': 'Hidden', 'COMUNA_1': 'TextEdit', 'Comuna': 'Hidden', 'Estra_MAX': 'TextEdit', 'ipm': 'TextEdit', 'DENSI_POB': 'TextEdit', 'Venezolano': 'TextEdit', 'TOT_VIV_OC': 'TextEdit', 'TOT_HOGARE': 'TextEdit', 'HA_TOT_PER': 'TextEdit', 'T_DESEMPLE': 'TextEdit', 'E_INFOR_F': 'Hidden', 'E_INFOR_E': 'TextEdit', 'DESE_JUVE': 'TextEdit', 'DEPEND_3_E': 'TextEdit', 'P_ALFA': 'TextEdit', 'PROMEDIO_A': 'TextEdit', 'PROMEDIO_1': 'TextEdit', 'PROMEDIO_2': 'TextEdit', 'DIF_M_H': 'TextEdit', 'E_VITA_SUF': 'TextEdit', 'V_TUGU': 'TextEdit', 'VIV_DURABL': 'TextEdit', 'P_ACU': 'TextEdit', 'P_ALC': 'TextEdit', 'P_ELEC': 'TextEdit', 'P_INTER': 'TextEdit', 'P_RECO_RES': 'TextEdit', 'Shanon_Est': 'TextEdit', 'U_Industri': 'TextEdit', 'U_Servici': 'TextEdit', 'U_Comercia': 'TextEdit', 'U_Mixto': 'TextEdit', 'U_Resid': 'TextEdit', 'U_PAR_ZVER': 'TextEdit', 'Salud': 'TextEdit', 'Educacion': 'TextEdit', 'Biblio_Mus': 'TextEdit', 'EP': 'TextEdit', 'R_Masa_': 'TextEdit', 'Innundac': 'TextEdit', 'RIESGO': 'Hidden', });
...
lyr_ProximidadaequipamientosdeEducacindistanciaenmetros_8.set('fieldLabels', {'COMUNA': 'inline label', 'ESTRATO': 'inline label', 'DIS_EDUCA': 'inline label', });
...
lyr_reaurbanaCcutayVilladelRosario_10.set('fieldLabels', {'ID_MANZA_1': 'header label', 'COMUNA_1': 'header label', 'Estra_MAX': 'header label', 'ipm': 'header label', 'DENSI_POB': 'header label', 'Venezolano': 'header label', 'TOT_VIV_OC': 'header label', 'TOT_HOGARE': 'header label', 'HA_TOT_PER': 'header label', 'T_DESEMPLE': 'header label', 'E_INFOR_E': 'header label', 'DESE_JUVE': 'header label', 'DEPEND_3_E': 'header label', 'P_ALFA': 'header label', 'PROMEDIO_A': 'header label', 'PROMEDIO_1': 'header label', 'PROMEDIO_2': 'header label', 'DIF_M_H': 'header label', 'E_VITA_SUF': 'header label', 'V_TUGU': 'header label', 'VIV_DURABL': 'header label', 'P_ACU': 'header label', 'P_ALC': 'header label', 'P_ELEC': 'header label', 'P_INTER': 'header label', 'P_RECO_RES': 'header label', 'Shanon_Est': 'header label', 'U_Industri': 'header label', 'U_Servici': 'header label', 'U_Comercia': 'header label', 'U_Mixto': 'header label', 'U_Resid': 'header label', 'U_PAR_ZVER': 'header label', 'Salud': 'header label', 'Educacion': 'header label', 'Biblio_Mus': 'header label', 'EP': 'header label', 'R_Masa_': 'header label', 'Innundac': 'header label', });
