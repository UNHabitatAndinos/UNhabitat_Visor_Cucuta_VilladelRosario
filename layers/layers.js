...
lyr_reaurbanaCcutayVilladelRosario_10.set('fieldAliases', {'ID_MANZA_1': 'Manzana', 'ID_MANZANA': 'ID_MANZANA', 'COMUNA_1': 'Comuna', 'Comuna': 'Comuna', 'Estra_MAX': 'Estrato', 'ipm': 'Índice de pobreza multidimencional - IPM (%)', 'DENSI_POB': 'Densidad de población', 'Venezolano': 'Total personas con nacionalidad Venezolana', 'TOT_VIV_OC': 'Total viviendas ocupadas', 'TOT_HOGARE': 'Total hogares', 'HA_TOT_PER': 'Total personas', 'T_DESEMPLE': 'Tasa de desempleo (%)', 'E_INFOR_F': 'Empleo informal', 'E_INFOR_E': 'Porcentaje de Empleo informal (e)', 'DESE_JUVE': 'porcentaje de desempleo juvenil', 'DEPEND_3_E': 'Dependencia de mayores', 'P_ALFA': 'Tasa de alfabetización', 'PROMEDIO_A': 'Promedio años de escolaridad', 'PROMEDIO_1': 'Promedio años de escolaridad hombres ', 'PROMEDIO_2': 'Promedio años de escolaridad mujeres ', 'DIF_M_H': 'Paridad de género', 'E_VITA_SUF': 'Hacinamiento', 'V_TUGU': 'Vivienda en tugurios', 'VIV_DURABL': 'Porcentaje de vivienda durable', 'P_ACU': 'Porcentaje a acceso a agua mejorada', 'P_ALC': 'Porcentaje a acceso a saneamiento', 'P_ELEC': 'Porcentaje de acceso a electricidad', 'P_INTER': 'Porcentaje de acceso a internet', 'P_RECO_RES': 'Recolección de residuos sólidos', 'Shanon_Est': 'Índice de shannon- mixticidad del suelo', 'U_Industri': 'Unidades con uso industrial', 'U_Servici': 'Unidades con uso de servicios', 'U_Comercia': 'Unidades con uso de comercial', 'U_Mixto': 'Unidades con uso de mixto', 'U_Resid': 'Unidades con uso residencial', 'U_PAR_ZVER': 'Unidades con uso de parques o áreas verdes', 'Salud': 'Proximidad a equipamientos de salud, distancia en mts', 'Educacion': 'Proximidad a equipamientos de educación, distancia en mts', 'Biblio_Mus': 'Proximidad a bibliotecas y museos, distancia en mts', 'EP': 'Proximidad a espacios públicos, distancia en mts', 'R_Masa_': 'Amenaza por remoción en masa', 'Innundac': 'Amenaza por inundación', 'RIESGO': 'RIESGO', 'PM10': 'PM10', 'Pendiente': 'Pendiente', });
...
lyr_ViviendaadecuadaviviendasCNPV2018_6.set('fieldLabels', {'COMUNA': 'inline label', 'ESTRATO': 'inline label', 'AGUA_MEJOR': 'inline label', 'SANEAMIENT': 'inline label', 'ELECTRICI': 'inline label', 'INTERNET': 'inline label', 'R_R_SOL': 'inline label', 'VIV_ADE': 'inline label', 'VIV_TUG': 'inline label', 'HOGARES': 'inline label', 'PERSONAS': 'inline label', 'REMOCIÓN': 'inline label', 'INUNDACIÓ': 'inline label', });
...
lyr_reaurbanaCcutayVilladelRosario_10.set('fieldLabels', {'ID_MANZA_1': 'header label', 'COMUNA_1': 'header label', 'Estra_MAX': 'header label', 'ipm': 'header label', 'TOT_HOGARE': 'header label', 'HA_TOT_PER': 'header label', 'T_DESEMPLE': 'header label', 'E_INFOR_E': 'header label', 'DESE_JUVE': 'header label', 'PROMEDIO_A': 'header label', 'VIV_DURABL': 'header label', 'P_ACU': 'header label', 'P_ALC': 'header label', 'P_ELEC': 'header label', 'P_INTER': 'header label', 'U_Mixto': 'header label', 'Salud': 'header label', 'Educacion': 'header label', 'Biblio_Mus': 'header label', 'EP': 'header label', 'R_Masa_': 'header label', 'Innundac': 'header label', 'PM10': 'header label', });
