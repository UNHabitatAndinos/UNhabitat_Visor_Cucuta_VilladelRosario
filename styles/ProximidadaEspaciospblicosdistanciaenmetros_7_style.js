...
var style_ProximidadaEspaciospblicosdistanciaenmetros_7 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("DIS_EP");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 300.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 301.000000 && value <= 500.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 501.000000 && value <= 700.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 701.000000 && value <= 1000.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 486.816348 && value <= 2094.450333) {
            style = [ new ol.style.Style({
