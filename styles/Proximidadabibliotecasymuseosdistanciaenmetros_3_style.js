...
var style_Proximidadabibliotecasymuseosdistanciaenmetros_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("DIS_BIBLIO");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 300.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1000.000000 && value <= 5030.770000) {
            style = [ new ol.style.Style({
