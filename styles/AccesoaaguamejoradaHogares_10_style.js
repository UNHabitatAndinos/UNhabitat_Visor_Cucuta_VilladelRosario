...
var style_AccesoaaguamejoradaHogares_10 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (value >= 0.001000 && value <= 30.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 60.000000 && value <= 81.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 81.000000 && value <= 95.000000) {
            style = [ new ol.style.Style({
